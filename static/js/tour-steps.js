...
const tourSteps = [
    ...
    },
    {
        ...
        message: 'Sometimes data is not captured consecutively across time and has gaps. This fills in missing data points by averaging neighboring values. Has no effect on data without gaps so let\'s leave it off for the demo.',
        position: 'right',
        waitFor: null,
        action: null,
        skipScroll: false
    },
    {
        ...
        message: 'Choose what the z-axis shows: raw flux or variability in percentage.',
        position: 'right',
        waitFor: null,
        action: null,
        skipScroll: false
    },
    {
        ...
        title: 'Data Ranges',
        message: 'Here you can edit the ranges of data displayed. This can be used to leave out outliers or zoom into a section. Let\'s leave it blank for the demo.',
        position: 'right',
        waitFor: null,
        action: null
    },
    ...
    },
    {
        ...
        message: 'This 3D visualization shows flux or flux variability across wavelength and time. You can rotate and zoom.',
        position: 'left',
        waitFor: null,
        action: null,
        skipScroll: false
